...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Map settings = {'temp': true, 'wind': true, 'pressure': true};
  ...
  Weather current = Weather(temp: 0, pressure: 0, humidity: 0, wind: 0, dt: 0, weatherType: '');
  List<Weather> hourly = [];
  List<Weather> daily = [];
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (_) => FavoritesPage(setCity)));
                  },
                ),
                ListTile(
        ...
        body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              daily = data['daily'].map<Weather>((el)=>Weather.fromJSONDaily(el)).toList();
              return Slide(
        ...
        Padding(
          ...
          child: Visibility(
            ...
            child: Row(
              children: [
                Text(
                  DateFormat.yMMMMd('ru').format(DateTime.fromMillisecondsSinceEpoch(widget.daily[0].dt * 1000)),
              ...
              Neumorphic(
                  ...
                  child: Column(
                    children: [
                      ...
                      Image.asset(getIcon(widget.hourly[0].weatherType), height: 50, width: 50),
                      Text(
                        '${widget.settings['temp'] ? widget.hourly[0].temp : (widget.hourly[0].temp*1.8+32).round()}',
                        style: GoogleFonts.manrope(fontSize: 15),
                      ),
                    ],
                  )),
                  ...
                  children: [
                    Expanded(
                      child: WeatherDetails(widgets: [
                        ...
                        Text(
                          '${widget.settings['temp'] ? widget.hourly[0].temp : widget.hourly[0].temp*1.8+32}',
                          style: GoogleFonts.manrope(fontSize: 15),
                        ),
                        Text(
                    ...
                    children: [
                      Expanded(
                        child: WeatherDetails(widgets: [
                          ...
                          Text(
                            '${widget.settings['wind'] ? widget.hourly[0].wind : (widget.hourly[0].wind/3.6).round()}',
                            style: GoogleFonts.manrope(fontSize: 15),
                          ),
                          Text(
                      ...
                      Expanded(
                        child: WeatherDetails(widgets: [
                          Icon((Icons.av_timer)),
                          Text(
                            '${widget.settings['pressure'] ? (widget.hourly[0].pressure/1.3).round() : (widget.hourly[0].pressure).round()}',
                            style: GoogleFonts.manrope(fontSize: 15),
                          ),
                          Text(
                            widget.settings['pressure'] ? 'мм.рт.ст' : 'гПа',
                            style: GoogleFonts.manrope(
                              fontSize: 15,
                              color: Colors.black,
                            ),
                ...
                Column(
                  ...
                  children: [
                    Visibility(
                      visible: isClosed,
                      child: Padding(
                        padding: const EdgeInsets.fromLTRB(1, 15, 0, 1),
                        child: Text(
                          widget.name,
                          style: GoogleFonts.manrope(
                              fontSize: 16,
